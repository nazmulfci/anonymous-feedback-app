...
<main class="">
    <div class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50 py-6 sm:py-12">
        ...
        <?php if(isset($_SESSION['status'])){ ?>
            <div class="mx-auto w-full max-w-xl text-center px-24 mb-3">
            <?php if($_SESSION['status']==1){ ?>
                <h1 class="block text-center font-bold text-2xl bg-gradient-to-r from-green-600 via-green-500 to-green-400 inline-block text-transparent bg-clip-text"><?php echo $_SESSION['message']; ?></h1>
                <?php }
                else if($_SESSION['status']==2){ ?>
                <h1 class="block text-center font-bold text-2xl bg-gradient-to-r from-red-600 via-red-500 to-red-400 inline-block text-transparent bg-clip-text"><?php echo $_SESSION['message']; ?></h1>
                <?php } ?>
            </div>
       <?php 
            ...
            <div class="mx-auto max-w-xl">
                <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                    ...
                    <div class="mt-10 mx-auto w-full max-w-xl">
                        <form class="space-y-6" action="../controller/Registration.php" method="POST">
                            <div>
